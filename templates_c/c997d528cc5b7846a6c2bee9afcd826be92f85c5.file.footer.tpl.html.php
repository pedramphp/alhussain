<?php /* Smarty version Smarty-3.0.6, created on 2011-08-13 15:44:49
         compiled from "/var/www/vhosts/alhussaintv.tv/project/al8/templates/includes/default/footer.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:3823890194e46d431d533a2-59015784%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c997d528cc5b7846a6c2bee9afcd826be92f85c5' => 
    array (
      0 => '/var/www/vhosts/alhussaintv.tv/project/al8/templates/includes/default/footer.tpl.html',
      1 => 1312920427,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3823890194e46d431d533a2-59015784',
  'function' => 
  array (
  ),
...
blogs'><i></i>Blog</a></li>
 ...
 $_from = $_smarty_tpl->getVariable('SiteData')->value['footer']['blogs']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['blog']->key => $_smarty_tpl->tpl_vars['blog']->value){
?>
							<li><a title='<?php echo $_smarty_tpl->tpl_vars['blog']->value['title'];?>
' href='<?php echo $_smarty_tpl->tpl_vars['blog']->value['link'];?>
'><i></i><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['blog']->value['title'],30,"...");?>
</a></li>
							<?php }} ?>
						</ul>
					</nav>					
 ...
 $_from = $_smarty_tpl->getVariable('SiteData')->value['footer']['events']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['event']->key => $_smarty_tpl->tpl_vars['event']->value){
?>
							<li><a title='<?php echo $_smarty_tpl->tpl_vars['event']->value['title'];?>
' href='<?php echo $_smarty_tpl->tpl_vars['event']->value['link'];?>
'><i></i><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['event']->value['title'],30,"...");?>
</a></li>
							<?php }} ?>
						</ul>
					</nav>					
				...
				<section id='favorite-footer'>
					...
					<nav>
						<ul>
							...
							<li><a href='http://alanwar.tv/'><i></i>Al Anwar TV</a></li>
							<li><a href='http://zahratv.com/'><i></i>Zahra TV</a></li>
							<li><a href='http://ahlulbayt.tv/'><i></i>Ahlul Bayt TV</a></li>
							<li><a href='http://salaamtv.org/'><i></i>Salam TV</a></li>
 ...
 $_from = $_smarty_tpl->getVariable('SiteData')->value['footer']['books']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
				...
				<section id='social-footer'>
					...
					<ul id='footer-fb-rss'>
						<li id='footer-fb-icon' class='clearfix'>
							<figure data-href="http://www.facebook.com/pages/Anwar-Al-Hussain-Guidance-for-Revival/160722923969793"></figure>
							<span>Join us in facebook</span>
							<span>Share us with your friends</span>						
						</li>
						<li id='footer-rss-icon' class='clearfix'>
							<figure data-href='<?php echo $_smarty_tpl->getVariable('applicationPath')->value;?>
feed'></figure>
							<span>RSS Feed</span>
							<span>Subscribe now to read our blog</span>
						</li>
...
?>
			...
			<section id="sponsers-footer" class='main-footer-section'>
				...
				<div class='carousel-big carousel clearfix'>
					<a href='javascript:void(0)' class='prev links' style='display:none' ><figure class='ir'>previous sponser</figure></a>
					<nav>
...
sponsors'>Kabob Factory Lorton VA</a></h2></li>
					...
					<a href='javascript:void(0)' class='next links' style='display:none' ><figure class='ir'>next sponser</figure></a>
				</div>
			</section> <!-- </sponsers> -->
		</div> <!-- </main-footer div> -->
	</footer>
...
contact'>Contact us</a>| 
					<a itemprop='url' href='<?php echo $_smarty_tpl->getVariable('applicationPath')->value;?>
volunteer'>Become a volunteer</a> 
				</p>
			</li> 
