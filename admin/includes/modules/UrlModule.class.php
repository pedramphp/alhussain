...
class UrlModule {
	...
	public static $EVENTS_THUMB_FILE_PATH;
	public static $EVENTS_THUMB_PATH;
	...
	public function __construct(){
		...
		self::$EVENTS_THUMB_FILE_PATH = self::getImageFilePath()."events/";
		self::$EVENTS_THUMB_PATH = self::getImagePath()."events/";
	...
	private static function getImagePath(){
		return dirname(LiteFrame::getApplicationPath())."/images/";
	}
	
	private static function getImageFilePath(){
		
		return dirname(LiteFrame::getFileSystemPath())."/images/";
	}	
}
new UrlModule();
