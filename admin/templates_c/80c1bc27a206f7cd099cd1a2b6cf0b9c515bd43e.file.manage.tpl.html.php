<?php /* Smarty version Smarty-3.0.6, created on 2011-08-15 00:46:54
         compiled from "/var/www/vhosts/alhussaintv.tv/project/al8/admin/templates/includes/videocategory/manage.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:20278659064e48a4be7fb154-14317105%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80c1bc27a206f7cd099cd1a2b6cf0b9c515bd43e' => 
    array (
      0 => '/var/www/vhosts/alhussaintv.tv/project/al8/admin/templates/includes/videocategory/manage.tpl.html',
      1 => 1312516980,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20278659064e48a4be7fb154-14317105',
  'function' => 
  array (
  ),
...
?>
					<tr>
						<td>
							<a class='album' href='<?php echo $_smarty_tpl->tpl_vars['videoCategory']->value['videos'];?>
'>
								<img class='imageAlbumThumb' src="<?php if ($_smarty_tpl->tpl_vars['videoCategory']->value['albumCover']==''){?><?php echo ($_smarty_tpl->getVariable('imagePath')->value).("no_photo_icon.gif");?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['videoCategory']->value['albumCover'];?>
<?php }?>" />
							</a>
						</td>
						<td>
